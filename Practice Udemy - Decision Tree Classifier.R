...
# fitting the Decision Tree classifier and predicting the test set results
...
y_grid = predict(dt_classifier, newdata = grid_set, type = 'class')
plot(set[, -3],
...
# Plotting the Decision Trees (should be run without feature scaling to get meaningful tree)
plot(dt_classifier)
text(dt_classifier)
