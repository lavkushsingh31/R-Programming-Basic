...
# fitting the Naive Bayes classifier and predicting the test set results

naive_bayes_classifier <- naiveBayes(x = training_set[-3],
                                     y = training_set$Purchased)

y_pred <- predict(naive_bayes_classifier, newdata = test_set[-3])
y_pred
...
y_grid = predict(naive_bayes_classifier, newdata = grid_set)
plot(set[, -3],
